...
@section ('title', appName() . ' | ' . __('shop::labels.backend.shop.management'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('shop::labels.backend.shop.management') }} <small class="text-muted">{{ __('shop::labels.backend.shop.list') }}</small>
                </h4>
            </div><!--col-->

            <div class="col-sm-7">
                @include('shop::includes.header-buttons')
            </div><!--col-->
        </div><!--row-->
