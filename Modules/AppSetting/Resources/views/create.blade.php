...
@section ('title', __('appsetting::labels.backend.appsetting.management') . ' | ' . __('appsetting::labels.backend.appsetting.create'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('appsetting::labels.backend.appsetting.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
