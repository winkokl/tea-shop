...
@section ('title', appName() . ' | ' . __('shoptable::labels.backend.shoptable.management'))
...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-7">
                @include('shoptable::includes.header-buttons')
            </div><!--col-->
        </div><!--row-->
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="table-responsive">
                    <table id="shoptable-table" class="table table-condensed table-hover">
                        <thead>
                        <tr>
...
@push('after-scripts')
    ...
    <script>
        $(function() {
            ...
            $('#shoptable-table').DataTable({
                serverSide: true,
                ajax: {
                    url: '{!! route("admin.shoptable.get") !!}',
                    type: 'post',
