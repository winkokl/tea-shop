        ...
        <div class="card-body">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    {{ html()->label(__('order::labels.backend.order.table.name'))->class('col-md-2 form-control-label')->for('name') }}

                        <div class="col-md-10">
                            {{ html()->text('name')
                                ->class('form-control')
                                ->placeholder(__('order::labels.backend.order.table.name'))
                    ...
                    <div class="form-group row">
                    {{ html()->label(__('order::labels.backend.order.table.description'))->class('col-md-2 form-control-label')->for('description') }}

                        <div class="col-md-10">
                            {{ html()->textarea('description')
                                ->class('form-control')
                                ->placeholder(__('order::labels.backend.order.table.description'))
                                ->required() }}
                        </div><!--col-->
                    </div><!--form-group-->
                </div><!--col-->
