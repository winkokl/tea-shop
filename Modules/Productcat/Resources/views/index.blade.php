...
@section ('title', appName() . ' | ' . __('productcat::labels.backend.productcat.management'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('productcat::labels.backend.productcat.management') }} <small class="text-muted">{{ __('productcat::labels.backend.productcat.list') }}</small>
                </h4>
            </div><!--col-->

            <div class="col-sm-7">
                @include('productcat::includes.header-buttons')
            </div><!--col-->
        </div><!--row-->
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="table-responsive">
                    <table id="productcat-table" class="table table-condensed table-hover">
                        <thead>
                        <tr>
...
@push('after-scripts')
    ...
    <script>
        $(function() {
            ...
            $('#productcat-table').DataTable({
                serverSide: true,
                ajax: {
                    url: '{!! route("admin.productcat.get") !!}',
                    type: 'post',
