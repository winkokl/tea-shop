...
@section ('title', __('recyclebin::labels.backend.recyclebin.management') . ' | ' . __('recyclebin::labels.backend.recyclebin.create'))
...
@section('content')
{{ html()->form('POST', route('admin.recyclebin.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('recyclebin::labels.backend.recyclebin.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
