        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div x-data="{userType : '{{ $model::TYPE_USER }}'}">
                    ...
                    <div class="form-group row">
                        <label for="mobile" class="col-md-2 col-form-label">@lang('Mobile No')</label>

                        <div class="col-md-10">
                            <input type="mobile" name="mobile" class="form-control" placeholder="{{ __('Mobile No') }}" value="{{ old('mobile') }}" maxlength="255" />
                        </div>
                    </div><!--form-group-->
